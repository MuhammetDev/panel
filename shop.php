      ...
      <div class="row items-push">
        <div class="col-md-4 col-xl-4">
          <div class="block block-rounded h-80 mb-0">
            ...
            <div class="block-content">
              <div class="mb-1">
                <div class="fw-semibold float-end ms-1 rainbow rainbow_text_animated">75₺</div>
		...
		<div class="col-md-4 col-xl-4">
          <div class="block block-rounded h-80 mb-0">
            ...
            <div class="block-content">
              <div class="mb-1">
                <div class="fw-semibold float-end ms-1 rainbow rainbow_text_animated">100₺</div>
		...
		<div class="col-md-4 col-xl-4">
          <div class="block block-rounded h-80 mb-0">
            ...
            <div class="block-content">
              <div class="mb-1">
                <div class="fw-semibold float-end ms-1 rainbow rainbow_text_animated">125₺</div>
		...
		<div class="col-md-6 col-xl-6">
          <div class="block block-rounded h-80 mb-0">
            ...
            <div class="block-content">
              <div class="mb-1">
                <div class="fw-semibold float-end ms-1 rainbow rainbow_text_animated">275₺</div>
		...
		<div class="col-md-6 col-xl-6">
          <div class="block block-rounded h-80 mb-0">
            ...
            <div class="block-content">
              <div class="mb-1">
                <div class="fw-semibold float-end ms-1 rainbow rainbow_text_animated">80₺</div>
		...
		<div class="col-md-12 col-xl-12">
          <div class="block block-rounded h-80 mb-0">
		  <center>
			<img id="logo-container" src="<?php echo $one->assets_folder; ?>/media/photos/illegalcity-banner_cropped_nobg.png" alt="Login Logo" style="width: 80%;">
		  </center>
          </div>
        </div>
