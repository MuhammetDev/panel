...
<div class="content content-boxed">
  <div class="row items-push py-4">
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <a class="block block-rounded block-link-pop h-100 mb-0" href="be_pages_elearning_course.php">
  ...
  <div class="content content-full content-boxed text-center">
    ...
    <div class="row items-push mt-5">
      <div class="col-md-4">
        ...
        <div class="fs-lg fw-semibold text-white mt-3"><?php $one->get_name('female'); ?></div>
        <div class="fs-sm text-white-75">Web Designer</div>
      </div>
      <div class="col-md-4">
        <?php $one->get_avatar(0, 'male', 64, true); ?>
        <div class="fs-lg fw-semibold text-white mt-3"><?php $one->get_name('male'); ?></div>
