      ...
      <form action="be_forms_input_groups.php" method="POST" onsubmit="return false;">
        <div class="row">
          ...
          <div class="col-lg-8 col-xl-5">
            ...
            <div class="mb-4">
              <div class="input-group">
                <span class="input-group-text input-group-text-alt">Name</span>
            ...
            <div class="mb-4">
              <div class="input-group">
                ...
                <span class="input-group-text input-group-text-alt">Email</span>
              </div>
            </div>
            <div class="mb-4">
              <div class="input-group">
          ...
          <div class="col-lg-8 col-xl-5">
            ...
            <div class="mb-4">
              <div class="input-group">
                ...
                <button type="button" class="btn btn-alt-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="visually-hidden">Toggle Dropdown</span>
                </button>
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="javascript:void(0)">
            ...
            <div class="mb-4">
              <div class="input-group">
                ...
                <button type="button" class="btn btn-alt-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="visually-hidden">Toggle Dropdown</span>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="javascript:void(0)">
