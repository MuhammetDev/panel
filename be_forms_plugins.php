...
<div class="content">
  ...
  <!-- Bootstrap Colorpicker (.js-colorpicker class is initialized in Helpers.jqColorpicker()) -->
  <!-- Currently only inline mode works with Bootstrap 5 --> 
      ...
      <form action="be_forms_plugins.php" method="POST" onsubmit="return false;">
          ...
          <div class="col-lg-8 col-xl-6">
            <div class="row">
              <div class="col-xl-6 mb-4">
                <label class="form-label" for="example-colorpicker1">Normal</label>
              ...
              <div class="col-xl-6 mb-4">
                <label class="form-label" for="example-colorpicker2">Component</label>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-xl-6">
            <div class="row">
              <div class="col-xl-6 mb-4">
                <label class="form-label" for="example-colorpicker3">Normal</label>
              ...
              <div class="col-xl-6 mb-4">
                <label class="form-label" for="example-colorpicker4">Component</label>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-xl-6">
            <div class="row mb-4">
              ...
              <div class="col-sm-6">
                <label class="form-label">With Transparency</label>
