...
<!-- Page Content -->
<!-- Image Cropper demo functionality is initialized in js/pages/be_comp_image_cropper.min.js which was auto compiled from _js/pages/be_comp_image_cropper.js -->
