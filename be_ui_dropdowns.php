      ...
      <div class="row items-push mb-4">
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-secondary">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-success">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-info">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-danger">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-dark">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
      ...
      <div class="row items-push mb-4">
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-outline-success">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-outline-info">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-outline-warning">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-outline-danger">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-outline-dark">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-outline-light">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
      ...
      <div class="row items-push mb-4">
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-alt-success">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-alt-warning">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-sm-6 col-xl-4">
          <div class="dropdown">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-default-alt-danger">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
          ...
          <div class="row items-push mb-4">
            ...
            <div class="col-xl-4">
              <div class="btn-group">
                ...
                <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-split-alt-danger">
                  <a class="dropdown-item" href="javascript:void(0)">Action</a>
                  <a class="dropdown-item" href="javascript:void(0)">Another action</a>
                  <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
                  <div class="dropdown-divider"></div>
            ...
            <div class="col-xl-4">
              <div class="btn-group">
                ...
                <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-split-warning">
                  <a class="dropdown-item" href="javascript:void(0)">Action</a>
                  <a class="dropdown-item" href="javascript:void(0)">Another action</a>
                  <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
                  <div class="dropdown-divider"></div>
          ...
          <div class="row items-push mb-4">
            <div class="col-sm-6 text-end">
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end fs-sm" aria-labelledby="dropdown-align-primary">
                  <a class="dropdown-item" href="javascript:void(0)">Action</a>
                  <a class="dropdown-item" href="javascript:void(0)">Another action</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
  ...
  <div class="block block-rounded">
    ...
    <div class="block-content">
      ...
      <div class="dropdown push">
        <button type="button" class="btn btn-primary dropdown-toggle" id="dropdown-content-rich-primary" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Form in dropdown
        </button>
      ...
      <div class="row items-push mb-4">
        <div class="col-md-4">
          ...
          <div class="dropdown dropup push">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-dropup-secondary">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
          ...
          <div class="dropdown dropup push">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-dropup-outline-secondary">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
          ...
          <div class="dropdown dropup">
            <button type="button" class="btn btn-alt-secondary dropdown-toggle" id="dropdown-dropup-alt-secondary" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Up
            </button>
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-dropup-alt-secondary">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-md-4">
          ...
          <div class="dropdown dropend push">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-dropright-primary">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
          ...
          <div class="dropdown dropend push">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-dropright-outline-primary">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
          ...
          <div class="dropdown dropend">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-dropright-alt-primary">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
        ...
        <div class="col-md-4 text-end">
          ...
          <div class="dropdown dropstart push">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-dropleft-dark">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
          ...
          <div class="dropdown dropstart push">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-dropleft-outline-dark">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
          ...
          <div class="dropdown dropstart">
            ...
            <div class="dropdown-menu fs-sm" aria-labelledby="dropdown-dropleft-alt-dark">
              <a class="dropdown-item" href="javascript:void(0)">Action</a>
              <a class="dropdown-item" href="javascript:void(0)">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)">Something else here</a>
