...
<div class="content">
  ...
  <div class="block block-rounded">
    <div class="block-header block-header-default">
      <h3 class="block-title">Outline</h3>
    </div>
    <div class="block-content">
      <p class="fs-sm text-muted">
  ...
  <!-- Ripple -->
  <!-- Ripple functionality ([data-toggle="click-ripple"] is initialized in Helpers.oneRipple()) -->
  <div class="block block-rounded">
    <div class="block-header block-header-default">
      <h3 class="block-title">Ripple</h3>
    </div>
    <div class="block-content">
      <p class="fs-sm text-muted">
      ...
      <div class="row items-push text-center text-sm-start mb-4">
        ...
        <div class="col-sm-6 col-xl-4">
          <button type="button" class="btn btn-alt-secondary" data-toggle="click-ripple">Light</button>
        </div>
      </div>
      <!-- END Default -->
  ...
  <div class="block block-rounded">
    <div class="block-header block-header-default">
      <h3 class="block-title">Small Size</h3>
    </div>
    <div class="block-content">
      <p class="fs-sm text-muted">
      ...
      <div class="row items-push text-center text-sm-start mb-4">
        ...
        <div class="col-sm-6 col-xl-4">
          <button type="button" class="btn btn-sm btn-alt-secondary">Light</button>
        </div>
      </div>
      <!-- Default -->
  ...
  <div class="block block-rounded">
    <div class="block-header block-header-default">
      <h3 class="block-title">Large Size</h3>
    </div>
    <div class="block-content">
      <p class="fs-sm text-muted">
      ...
      <div class="row items-push text-center text-sm-start mb-4">
        ...
        <div class="col-sm-6 col-xl-4">
          <button type="button" class="btn btn-lg btn-alt-secondary">Light</button>
        </div>
      </div>
      <!-- END Default -->
  ...
  <div class="block block-rounded">
    ...
    <div class="block-content">
      ...
      <div class="row items-push text-center text-sm-start mb-4">
        ...
        <div class="col-sm-6 col-xl-4">
          <button type="button" class="btn rounded-0 btn-alt-secondary">Light</button>
        </div>
      </div>
      <!-- END Default -->
  ...
  <div class="block block-rounded">
    ...
    <div class="block-content">
      ...
      <div class="row items-push text-center text-sm-start mb-4">
        ...
        <div class="col-sm-6 col-xl-4">
          <button type="button" class="btn rounded-pill btn-alt-secondary">Light</button>
        </div>
      </div>
      <!-- END Default -->
  ...
  <div class="block block-rounded">
    ...
    <div class="block-content">
      ...
      <div class="row items-push text-center text-sm-start mb-4">
        ...
        <div class="col-sm-6 col-xl-4">
          <button type="button" class="btn btn-alt-secondary" disabled>Light</button>
        </div>
      </div>
      <!-- END Default -->
  ...
  <div class="block block-rounded">
    <div class="block-header block-header-default">
      <h3 class="block-title">Be Creative</h3>
    </div>
    <div class="block-content">
      <p class="fs-sm text-muted">
        Mix any of the available classes to create the button style you want to use in your project
      </p>
      <button type="button" class="btn btn-lg rounded-0 btn-secondary me-1 mb-3">
      ...
      <button type="button" class="btn btn-lg rounded-0 btn-alt-secondary me-1 mb-3">
      ...
      <button type="button" class="btn btn-lg rounded-pill btn-alt-success px-4 me-1 mb-3">
