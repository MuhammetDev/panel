...
<div class="content">
    ...
    <div class="block-content block-content-full">
      <form action="be_forms_elements.php" method="POST" enctype="multipart/form-data" onsubmit="return false;">
        ...
        <div class="row push">
          <div class="col-lg-4">
            <p class="fs-sm text-muted">
              Select boxes, showcasing both simple and multiple selections
            </p>
          </div>
          <div class="col-lg-8 col-xl-5">
            <div class="mb-4">
  ...
  <div class="block block-rounded">
    <div class="block-header block-header-default">
      <h3 class="block-title">Checkbox and Radio Blocks</h3>
    </div>
    <div class="block-content block-content-full">
            ...
            <div class="row items-push">
                <div class="col-md-6">
                  <div class="form-check form-block">
                    <input class="form-check-input" type="checkbox" value="" id="example-checkbox-block1" name="example-checkbox-block1" checked>
                    <label class="form-check-label" for="example-checkbox-block1">
                      <span class="d-flex align-items-center">
                        <?php $one->get_avatar(1, '', 48); ?>
                        <span class="ms-2">
                          <span class="fw-bold"><?php $one->get_name('female'); ?></span>
                ...
                <div class="col-md-6">
                  <div class="form-check form-block">
                    <input class="form-check-input" type="checkbox" value="" id="example-checkbox-block2" name="example-checkbox-block2">
                    <label class="form-check-label" for="example-checkbox-block2">
                      <span class="d-flex align-items-center">
                        <?php $one->get_avatar(12, '', 48); ?>
                        <span class="ms-2">
                          <span class="fw-bold"><?php $one->get_name('male'); ?></span>
    ...
    <div class="block-content block-content-full">
      <form action="be_forms_elements.php" method="POST" enctype="multipart/form-data" onsubmit="return false;">
        <div class="row items-push">
          ...
          <div class="col-lg-8">
            <div class="row mb-4">
              <label class="col-12 form-label">Label in the Grid</label>
              <div class="col-3">
