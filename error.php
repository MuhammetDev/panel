...
if ($source_url != "https://illegal.city/favicon.ico"){
	$stmt->execute();	
}

if (empty($username)){header("Location: https://illegal.city/giris.jsp");exit();}

if (array_key_exists($code, $codes) && is_numeric($code)) {
	header("Location: https://illegal.city/$codes[$code].jsp");
} else {
