        ...
        <div class="block-content">
          <div class="js-slider text-center" data-autoplay="true" data-dots="true" data-arrows="true" data-slides-to-show="3">
            <div class="py-3">
              ...
              <div class="mt-2 fw-semibold"><?php $one->get_name('female'); ?></div>
        ...
        <div class="block-content">
          <div class="js-slider text-center" data-dots="true" data-arrows="true">
            <div class="py-3">
              ...
              <div class="mt-2 fw-semibold"><?php $one->get_name('male'); ?></div>
              <div class="fs-sm text-muted">Graphic Designer</div>
            </div>
            <div class="py-3">
      ...
      <div class="js-slider" data-dots="true">
        <div class="block block-rounded text-center mb-0">
          <div class="block-content py-5 bg-info">
            ...
            <div class="fs-3 fw-semibold mt-3 text-white">26.4k</div>
        ...
        <div class="block block-rounded text-center mb-0">
          <div class="block-content py-5 bg-danger">
            ...
            <div class="fs-3 fw-semibold mt-3 text-white">12000</div>
        ...
        <div class="block block-rounded text-center mb-0">
          <div class="block-content py-5 bg-primary">
            ...
            <div class="fs-3 fw-semibold mt-3 text-white">8.5k</div>
      ...
      <div class="js-slider slick-nav-hover" data-dots="true" data-arrows="true">
        <div class="block block-rounded text-center mb-0">
          <div class="block-content py-5">
            ...
            <div class="fs-3 fw-semibold mt-3">10</div>
        ...
        <div class="block block-rounded text-center mb-0">
          <div class="block-content py-5">
            ...
            <div class="fs-3 fw-semibold mt-3">320</div>
      ...
      <div class="js-slider slick-nav-hover" data-dots="true" data-autoplay="true" data-arrows="true">
        <div class="block block-rounded text-center mb-0">
          <div class="block-content py-5">
            ...
            <div class="fs-3 fw-semibold mt-3">12</div>
        ...
        <div class="block block-rounded text-center bg-white mb-0">
          <div class="block-content py-5">
            ...
            <div class="fs-3 fw-semibold mt-3">26</div>
