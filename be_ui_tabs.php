    ...
    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
      <div class="flex-grow-1">
        ...
        <h2 class="fs-base lh-base fw-medium text-muted mb-0">
          Generate tabbed interfaces with ease.
        </h2>
      </div>
...
<!-- Page Content -->
<!-- For advanced Tabs usage you can check out https://getbootstrap.com/docs/5.0/components/navs-tabs/ -->
<div class="content">
  <!-- Vertical Block Tabs -->
  ...
  <div class="row">
    ...
    <div class="col-lg-6">
      ...
      <div class="block block-rounded row flex-md-row-reverse g-0">
        <ul class="nav nav-tabs nav-tabs-block justify-content-end justify-content-md-start flex-md-column col-md-4" role="tablist">
          <li class="nav-item d-md-flex flex-md-column">
