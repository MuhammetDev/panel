        ...
        <tbody>
          <tr class="bg-body-light">
            ...
            <td class="fs-sm text-muted">
              <a class="fw-semibold" href="be_pages_generic_profile.php"><?php $one->get_name('female'); ?></a> on <span class="text-muted">July 1, 2019 16:15</span>
            </td>
          </tr>
          <tr>
          ...
          <tr class="bg-body-light">
            <td class="d-none d-sm-table-cell"></td>
            <td class="fs-sm text-muted">
              <a class="fw-semibold" href="be_pages_generic_profile.php"><?php $one->get_name('male'); ?></a> on <span class="text-muted">July 10, 2019 10:09</span>
            </td>
          </tr>
          <tr>
            <td class="d-none d-sm-table-cell text-center" style="width: 140px;">
          ...
          <tr class="bg-body-light">
            <td class="d-none d-sm-table-cell"></td>
            <td class="fs-sm text-muted">
              <a class="fw-semibold" href="be_pages_generic_profile.php"><?php $one->get_name('male'); ?></a> on <span class="text-muted">July 15, 2019 20:17</span>
            </td>
          </tr>
          <tr>
            <td class="d-none d-sm-table-cell text-center" style="width: 140px;">
          ...
          <tr class="bg-body-light">
            <td class="d-none d-sm-table-cell"></td>
            <td class="fs-sm text-muted">
              <a class="fw-semibold" href="be_pages_generic_profile.php"><?php $one->get_name('female'); ?></a> on <span class="text-muted">July 20, 2019 20:29</span>
            </td>
          </tr>
          <tr>
            <td class="d-none d-sm-table-cell text-center" style="width: 140px;">
